...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScoringRuleApps/Substandard Hospital (Client Based)/Increase SA Positive', [('transactionType') : transactionType
            , ('role') : role, ('riderCode') : riderCode, ('subAlter') : subAlter, ('substandardFlag') : substandardFlag]))
