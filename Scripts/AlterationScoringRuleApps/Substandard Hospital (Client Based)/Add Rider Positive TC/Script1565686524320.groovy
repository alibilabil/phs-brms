...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScoringRuleApps/Substandard Hospital (Client Based)/Add Rider Positive', [('transactionType') : 'Major'
            , ('role') : 'LA1', ('subAlter') : 'AddRider', ('riderCode') : 'H1G1', ('substandardHospitalFlag') : 'Y']))
