...
ResponseObject response =WS.sendRequest(findTestObject('AlterationScoringRuleApps/Substandard Hospital (Client Based)/Increase Plan Positive', [('transactionType') : transactionType
            , ('role') : role, ('riderCode') : riderCode, ('subAlterPlan') : subAlterPlan, ('substandardHospitalFlag') : substandardHospitalFlag]))
