...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScoringRuleApps/Substandard Hospital (Client Based)/Decrease SA Positive', [('transactionType') : transactionType
...
WS.comment('Verify evidence code is TPH')
WS.verifyEqual(expected, 'TPH')
