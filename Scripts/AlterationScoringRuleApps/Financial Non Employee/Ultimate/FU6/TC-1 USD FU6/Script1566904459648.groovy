...
final long compareHighestValueFsaDeathVsAddccMin = 6250000

final long compareHighestValueFsaDeathVsAddcc = Math.abs(random.nextLong() % (Long.MAX_VALUE - compareHighestValueFsaDeathVsAddccMin)) + compareHighestValueFsaDeathVsAddccMin
