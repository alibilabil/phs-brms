...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScoringRuleApps/NML Flag/TC-3 AddRider', [('transactionType') : transactionType, ('subAlter') : subAlter
