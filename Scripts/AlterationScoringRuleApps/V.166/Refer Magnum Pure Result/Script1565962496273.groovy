...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScoringRuleApps/V.166/Magnum Pure Result/Refer Magnum Pure Result', 
...
WS.comment('Verify evidence code is MRF')

WS.verifyEqual(expected, 'MRF')
