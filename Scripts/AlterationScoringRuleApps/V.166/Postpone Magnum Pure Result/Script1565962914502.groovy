...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScoringRuleApps/V.166/Magnum Pure Result/Postpone Magnum Pure Result', 
...
WS.comment('Verify evidence code is MDP')

WS.verifyEqual(expected, 'MDP')
