...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScoringRuleApps/PolicyLimit/Early Stage Limitation/Ver.Check_1.387/IncSumAss_Object Request', [('transactionType') : transactionType
            , ('role') : role, ('subAlter') : subAlter, ('eviCode') : eviCode, ('riderCode') : riderCode, ('riskClass') : riskClass
            , ('expectedEarlyStageLimitation') : expectedEarlyStageLimitation, ('expectedEvidenceCode') : expectedEvidenceCode, ('expectedDescription') : expectedDescription]))
