...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScoringRuleApps/PolicyLimit/Early Stage Payor Limitation/Ver.Check_1.387/AddRider_Object Request', 
        [('transactionType') : transactionType, ('role') : role, ('subAlter') : subAlter, ('eviCode') : eviCode, ('riderCode') : riderCode
            , ('compareNewFsaDeathandTotalccWithWop') : compareNewFsaDeathandTotalccWithWop]))
