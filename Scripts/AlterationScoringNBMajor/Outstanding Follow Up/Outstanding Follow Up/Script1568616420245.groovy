...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScroingNBMajor/Outstanding Follow Up/Version 1.0_Check_1.391/Object Request', [
            ('transactionType') : transactionType, ('followUpCode') : followUpCode, ('status') : status]))
