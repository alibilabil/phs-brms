...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScroingNBMajor/PPH Limitation for Juvenille/Version 1.0_Check_1.391/Object Request', 
        [('transactionType') : transactionType, ('clientType') : clientType, ('role') : role, ('subAlter') : subAlter, ('eviCode') : eviCode, ('riderCode') : riderCode
            , ('age') : age, ('sumAssured') : sumAssured]))
