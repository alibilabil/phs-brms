...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScroingNBMajor/PPH Limitation for Student and Housewife/Version 1.0_Check_1.391/Increase Plan Object Req', 
        [('transactionType') : transactionType, ('clientType') : clientType, ('role') : role, ('subAlter') : subAlter, ('riderCode') : riderCode, ('occupationCode') : occupationCode
            , ('ageNextBirthday') : ageNextBirthday, ('totalSumAssured') : totalSumAssured]))
