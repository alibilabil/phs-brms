...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScroingNBMajor/Occupation RDO List/Version 1.0_Check_1.391/Object Request', [('transactionType') : transactionType
