...
ResponseObject response = WS.sendRequest(findTestObject('AlterationScroingNBMajor/Entry Age Procedure 2/Version 1.0_Check_1.391/Negative_Object Request', 
...
if(isContain == false)
{
	println 'Expected evidence code tidak ada'
}
