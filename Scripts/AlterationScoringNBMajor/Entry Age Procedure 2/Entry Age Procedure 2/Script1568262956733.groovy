...
ResponseObject response =WS.sendRequest(findTestObject('AlterationScroingNBMajor/Entry Age Procedure 2/Version 1.0_Check_1.391/Object Request', [
            ('transactionType') : transactionType, ('productCode') : productCode, ('role') : role, ('age') : age, ('weight') : weight]))
